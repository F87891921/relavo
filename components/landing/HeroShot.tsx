...
export function HeroShot() {
  return (
        ...
        <text x="1411" y="38" fontFamily="Inter, sans-serif" fontSize="13" fontWeight="600" fill="#ffffff" textAnchor="middle">Ny kontroll</text>
        <rect x="1482" y="18" width="88" height="30" rx="8" fill="none" stroke="rgba(40,31,42,0.16)" strokeWidth="1"/>
        <text x="1526" y="38" fontFamily="Inter, sans-serif" fontSize="13" fontWeight="500" fill="#1d1d1f" textAnchor="middle">Logg ut</text>
        <rect x="0" y="64" width="260" height="636" fill="#ffffff"/>
        <line x1="260" y1="64" x2="260" y2="700" stroke="rgba(40,31,42,0.08)" strokeWidth="1"/>
        <text x="32" y="108" fontFamily="Inter, sans-serif" fontSize="14" fontWeight="600" fill="#654b70">+ Ny kontroll</text>
        <rect x="16" y="130" width="228" height="38" rx="8" fill="#f1ecf3" stroke="rgba(40,31,42,0.08)" strokeWidth="1"/>
        <text x="32" y="154" fontFamily="Inter, sans-serif" fontSize="14" fontWeight="600" fill="#1d1d1f">Leverandører</text>
        <text x="32" y="204" fontFamily="Inter, sans-serif" fontSize="14" fill="rgba(40,31,42,0.58)">Overvåkninger</text>
        <text x="32" y="248" fontFamily="Inter, sans-serif" fontSize="14" fill="rgba(40,31,42,0.58)">Historikk</text>
        <text x="32" y="292" fontFamily="Inter, sans-serif" fontSize="14" fill="rgba(40,31,42,0.58)">Leverandørkjede</text>
        ...
        <text x="300" y="128" fontFamily="Inter, sans-serif" fontSize="36" fontWeight="600" fill="#1d1d1f">Leverandører</text>
        <text x="300" y="158" fontFamily="Inter, sans-serif" fontSize="15" fill="rgba(40,31,42,0.58)">Bergen kommune · 148 aktive leverandører</text>
        <rect x="300" y="188" width="1264" height="108" rx="12" fill="#ffffff" stroke="rgba(40,31,42,0.08)" strokeWidth="1"/>
        <text x="330" y="226" fontFamily="Inter, sans-serif" fontSize="16" fontWeight="700" fill="#1d1d1f">Kontrollplikt § 5i</text>
        <text x="330" y="250" fontFamily="Inter, sans-serif" fontSize="13" fill="rgba(40,31,42,0.58)">136 av 148 leverandører dokumentert · sist oppdatert i dag</text>
        ...
        <text x="346" y="354" fontFamily="Inter, sans-serif" fontSize="14" fill="rgba(40,31,42,0.38)">Søk på selskapsnavn eller org.nr...</text>
        <rect x="958" y="326" width="70" height="46" rx="23" fill="#ffffff" stroke="#654b70" strokeWidth="1.5"/>
        <text x="993" y="354" fontFamily="Inter, sans-serif" fontSize="13" fontWeight="600" fill="#654b70" textAnchor="middle">Alle</text>
        <rect x="1040" y="326" width="196" height="46" rx="23" fill="#ffffff" stroke="rgba(40,31,42,0.16)" strokeWidth="1"/>
        <text x="1138" y="354" fontFamily="Inter, sans-serif" fontSize="13" fill="#1d1d1f" textAnchor="middle">Lav risiko</text>
        <rect x="1248" y="326" width="118" height="46" rx="23" fill="#ffffff" stroke="rgba(40,31,42,0.16)" strokeWidth="1"/>
        <text x="1307" y="354" fontFamily="Inter, sans-serif" fontSize="13" fill="#1d1d1f" textAnchor="middle">Høy risiko</text>
        ...
        <text x="300" y="416" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="rgba(40,31,42,0.38)">SELSKAP</text>
        <text x="650" y="416" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="rgba(40,31,42,0.38)">ORG.NR</text>
        <text x="870" y="416" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="rgba(40,31,42,0.38)">SIST KONTROLLERT</text>
        <text x="1150" y="416" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="rgba(40,31,42,0.38)">STATUS</text>
        ...
        <text x="1162" y="466" fontFamily="Inter, sans-serif" fontSize="14" fill="#15803d">Lav risiko</text>
        ...
        <text x="1162" y="518" fontFamily="Inter, sans-serif" fontSize="14" fill="#15803d">Lav risiko</text>
        ...
        <text x="1162" y="570" fontFamily="Inter, sans-serif" fontSize="14" fill="#c43b3b">Høy risiko</text>
        ...
        <text x="1162" y="622" fontFamily="Inter, sans-serif" fontSize="14" fill="#15803d">Lav risiko</text>
        </svg>
  );
}
